        ...
        <div class="login-form">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-12">
                <div class="card">
                <div style="font-size:18px" class="card-header">Consultar Histórico de Exames do Paciente</div>
                <div class="card-body">
                    ...
                    <div class="card-body">
                      <table width="90%" align="center" border="1px" cellpadding="5" id="#tabela-cima">
                        <tr>
                          ...
                          <th width="13.142%">Laboratório </th>
                          <th width="13.142%">CNPJ </th>
                          <th width="13.142%">Data </th>
                          <th width="13.142%">Hora </th>
                          <th width="13.142%">Resultado </th>
                        </tr>
