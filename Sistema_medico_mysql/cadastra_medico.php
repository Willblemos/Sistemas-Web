					...
					<div class="login-form">
  					<div class="container">
    					<div class="row justify-content-center">
      					<div class="col-md-8">
        					<div class="card">
          					<div style="font-size:16px;" class="card-header">Cadastro do Médico</div>
          					<div class="card-body">
            					<form action="" method="post"><input type="hidden" name="login" value="login" />

                        <div class="form-group row">
                					<label for="username" class="col-md-3 col-form-label text-md-right">Nome completo</label>
                					<div class="col-md-8">
                        ...
                        <div class="form-group row">
                					<label for="crm" class="col-md-3 col-form-label text-md-right">CRM</label>
                					<div class="col-md-8">
                  					<input type="number" class="form-control" name="crm" required>
                					</div>
                        </div>
                        ...
                        <div class="form-group row">
                					<label for="especialidade" class="col-md-3 col-form-label text-md-right">Especialidade</label>
                					<div class="col-md-8">
