...
if(isset($_POST['change'])){
  ...
  if(count($errors) == 0) {
     $err = $DB->edita_lab($id, $cnpj, $nome, $senha, $email, $endereco,$especialidade, $telefone);
     if($err == true) {
        session_start();
        $_SESSION['cnpj'] = $cnpj;
...
<!-- Masthead -->
<header style="background:linear-gradient(to bottom, rgba(0, 0, 0, 0.6) 30%, rgba(0, 0, 0, 0.6) 100%), url(../imga/consulta.jpg); background-position:center; background-repeat:no-repeat; background-attachment:scroll; background-size:cover; height:92vh; padding-top:0px;" class="masthead">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="" method="post"><input type="hidden" name="login" value="login" />
                      ...
                      <div class="form-group row">
                        <label for="tele" class="col-md-3 col-form-label text-md-right">Especialidade</label>
                        <div class="col-md-8">
