        ...
        <div class="login-form">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-8">
                <div class="card">
                  <div style="font-size:16px;" class="card-header">Cadastro do Paciente</div>
                  <div class="card-body">
                    <form action="" method="post"><input type="hidden" name="login" value="login" />
                      ...
                      <div class="form-group row">
                        <label for="genero" class="col-md-3 col-form-label text-md-right">Gênero</label>
                        <div class="col-md-8">
                      ...
                      <div class="form-group row">
                        <label for="idade" class="col-md-3 col-form-label text-md-right">Idade</label>
                        <div class="col-md-8">
