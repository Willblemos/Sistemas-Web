...
if(isset($_POST['change'])){
  ...
  if($err == null){
    ...
    if(($newname != $err)){
      ...
      $err2 = $DB->exame_cpf($clientid,$dat2, $hora2);
      if($err2 == true){
  ...
  if(count($errors) == 0){
    ...
    $err = $DB->edita_exame($id,$clientid, $newname,$dat2,$hora2, $resultado);
        ...
        <div class="login-form">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-8">
                <div class="card">
                  <div style="font-size:16px;" class="card-header">Alteração do Exame</div>
                  <div class="card-body">
                    <form action="" method="post"><input type="hidden" name="login" value="login" />
                      ...
                      <div class="form-group row">
                        <label for="obs" class="col-md-3 col-form-label text-md-right">Resultado</label>
                        <div class="col-md-8">
